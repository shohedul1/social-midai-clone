          ...
          >
            ...
            //    onSubmit={handleSubmit(onSubmitProfile)}
               >
                ...
                //   ref={profileImageInputRef}  onChange={handleProfilePictureChange}
                  />
                ...
                <div>
                  ...
                  <Select 
                //   onValueChange={(value) => setValue("gender", value)} defaultValue={profileData?.gender}
                  >
                    <SelectTrigger>
                ...
                >
                  <Save className="w-4 h-4 mr-2" /> {true ? "Saving...": "Save changes"}
                </Button>
              </form>
            </motion.div>
          </motion.div>
            ...
            >
              ...
              <form className="space-y-4">
                ...
                //   disabled = {!coverPhotoFile}
                  type="button"
                >
                  <Save className="w-4 h-4 mr-2" /> {true ? "Saving..." :"Save Cover Photo"}
                </Button>
              </form>
            </motion.div>
          </motion.div>
