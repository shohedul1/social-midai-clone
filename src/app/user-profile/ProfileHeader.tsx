...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
    ...
    const [isEditProfileModel, setIsEditProfileModel] = useState<boolean>(false);
    const [isEditCoverModel, setIsEditCoverModel] = useState<boolean>(false);
    ...
    const onSubmitCoverPhoto = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            setLoading(true);
            const formData = new FormData();
