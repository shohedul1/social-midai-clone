...
const mockUserPosts: Post[] = [
    {
        _id: "1",
        user: { username: "JohnDoe", profilePicture: "/path/to/profile.jpg" },
        ...
        commentCount: 2,
        shareCount: 3,
        likes: [], // Add an empty array or mock data as needed
        comments: [], // Add an empty array or mock data as needed
        share: [], // Add an empty array or mock data as needed
    },
    {
        _id: "2",
        user: { username: "JohnDoe", profilePicture: "/path/to/profile.jpg" },
